 ...
 * @brief: 
 * @version: 
 * @Date: 2025-02-22 01:58:15
 * @LastEditors:  
 * @LastEditTime: 2025-02-23 18:15:57
 */
#include "gamepad.h"
...
int main(int argc, char const *argv[])
{
    ...
    pad.bindGamePadValues([&](GamePadValues map)
        ...
        msg.linear.x = (double)-map.ry/32767*5;
        msg.linear.y = (double)-map.rx/32767*5;
        msg.linear.z = 0;
        msg.angular.x = (double)map.lx/32767*5;
        msg.angular.y = (double)map.ly/32767*5;
        msg.angular.z = (double)-map.ly/32767*5;
         });
    int is;
